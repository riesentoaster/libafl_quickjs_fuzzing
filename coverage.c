...
// Global variable for tracking compilation step (must be defined here for dlsym to find it)
__attribute__((visibility("default"))) size_t __afl_correctness_step = 0;
